...
petik = '```'
fake = '©PUTPAYBOT'//GANTI NAMA KAMU BEP
ban =[]
...
*Sewa bot?* Chat wa.me/6285893228346`
...
*Cek list Server GTIVD dibawah!*`
       ...
       case 'othercmd':
               ...
               listmsg(from, `${ucapanWaktu}`,   `Subscribe https://youtube.com/c/BroKenzchannelOfficial`, list)
               break
//------------------< Game >------------------- 
        case 'limitgame': 
        case 'balance': 
...
*Chat Owner :* wa.me/6285893228346`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
case 'pricegtfo':
              gopeynya = 'https://i.ibb.co/kynNYTh/ganteng.jpg'
...
*ID Guild :* -
*Minat Join? Chat* wa.me/6285893228346
#WAVEFOREVER!`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
...
"title": `Putpay Bot ~ 404 ${vipi}`,
"description": `${virtex}`,
"currencyCode": "IDR",
"priceAmount1000": "99999999999999999999999999999999",
"productImageCount": 1
},
"businessOwnerJid": "6285893228346@s.whatsapp.net",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport':
              ...
              dha.sendMessage('6285893228346@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
